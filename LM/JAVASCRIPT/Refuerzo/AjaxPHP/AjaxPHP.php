<?php
//Array de nombres
$a = array("Sara", "Imanol", "Dani", "Antonio", "David", "Igor", "Naroa", "Christian", "Joseba", "Angel", "Alex", "Dimitru", "Mikel", "Ivan", "Martin");
...
if ($nombre!==""){
    $nombre = strtolower($nombre); //Pasamos el nombre a minúscula
    $long = strlen($nombre);
